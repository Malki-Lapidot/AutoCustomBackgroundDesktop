...
# $remoteScriptUrl = "https://raw.githubusercontent.com/Malki-Lapidot/AutoCustomBackgroundDesktop/main/script1.ps1"
$remoteImageUrl  = "https://raw.githubusercontent.com/Malki-Lapidot/AutoCustomBackgroundDesktop/main/backgrounds/1.jpg"

# --- Target date / countdown ---
$targetDay  = Get-Date "2025-11-12"
$today      = Get-Date
